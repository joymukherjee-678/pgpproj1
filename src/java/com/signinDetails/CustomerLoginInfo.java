            ...
            /* TODO output your page here. You may use following sample code. */
                ...
                String password= request.getParameter("password");
                 ...
                 String email1="null",password1="null";
                  ...
                  ModelCustomerLoginDetails mcl= new ModelCustomerLoginDetails(email,password);
                
                
                  
                  ValidateCustomerLoginDetails vcld= new ValidateCustomerLoginDetails( );
                
                     //     out.println(email+""+password); 
                   
                   List l= vcld.GetData(mcl);
                    ...
                    //  String email2="nUll",password2="null";
                      ...
                      if(email1.equals(email) && password1.equals(password))
                      {
                        ...
                        RequestDispatcher rd = request.getRequestDispatcher("successValidate.jsp");
                    ...
                    else
                      {
                          ...
                          RequestDispatcher rd= request.getRequestDispatcher("CustomerSigninPage.jsp");
