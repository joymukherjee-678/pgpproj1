<%-- 
    Document   : deleteRecordsOf_a_SpecificCustomer
    Created on : 7 Jul, 2020, 1:49:23 PM
    Author     : Joy
--%>
...
<html>
    ...
    <body>
        ...
        <a href="deleteCustomer.jsp"> DELETE CUSTOMER </a>           &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
         ...
         <c:set var="fullName3" value="${sessionScope.fullName2}"/>
        
        <script>
        
         
         alert('all records of : '+ fullName3 + 'has been deleted permanentlly');
