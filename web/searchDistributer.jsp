<%-- 
    Document   : searchDistributer
    Created on : 16 Jul, 2020, 6:37:35 PM
    Author     : Joy
--%>
        ...
        <a href="distributerLogOutPage.jsp"> LOG OUT </a>           &nbsp;&nbsp;
            ...
            <table>
                ...
                <tr class="autostyle2">
                    ...
                    <td colspan="2"> SEARCH FOR A DISTRIBUTER</td>
            ...
            <input type="text"  size="100" name="distributerContact" required/>
